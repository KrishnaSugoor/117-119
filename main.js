...
randomnno=Math.floor((Math.random() * quick_draw_data_set.length) + 1);
sketch=quick_draw_data_set[randomnno];
document.getElementById("sketchname").innerHTML="sketch to be drawn is "+sketch;
tc=0;
cha="";
sket="";
ans="";
...
function draw(){
    ...
    function check(){
tc++;
document.getElementById("time").innerHTML="timer= "+tc;
if (tc>400){tc=0;
    cha="completed";

}
if(cha=="completed"||ans=="set"){
cha="";
ans="";
upd();
}
